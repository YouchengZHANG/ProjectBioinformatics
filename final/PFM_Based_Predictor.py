...
model = joblib.load('pfm_based_model.pkl')
print(model)
...
#  STEP 5: Build AA_table that convert each amino acid in each sequence into integer form
#  Twentry common amino acid 'ARNDCQEGHILKMFPSTWYV'
print('Creating tables...')
AA_table = Table_Creater.Table_Creater()[0]


#  STEP 6: Build int_stc_table that convert each integer form to the structure
#  Example:  int_stc_table[1] = S; stc_table[0] = .
int_stc_table = Table_Creater.Table_Creater()[3]


#  STEP 7: Create *_result folder to save predicted output (* refers to the name of unknown fasta file )
...
#  './*_result/align/' : saves the .align files from PSI-BLAST
...
#  STEP 8: Run Module: Predict_Separater
...
#  STEP 9: Run Module: Predict_Preprocessor 
...
#  STEP 10: Run Module: Predict_PFM_Processor 
...
for names in test_pid_all:
    test_window_input = Predict_PFM_Processor.Predict_PFM_Processor(names,test_pid_all,test_seq_all,dir_pssm)
...
#  STEP 11: Save the predicted output to file
